...
const Icons = {
  cart: () => (
    ...
    >
      <rect x="8" y="20" width="48" height="24" rx="4" fill="#b3b3b3" />
      <rect x="16" y="12" width="32" height="12" rx="2" fill="#b3b3b3" />
      <circle cx="20" cy="48" r="6" fill="#b3b3b3" />
      <circle cx="44" cy="48" r="6" fill="#b3b3b3" />
    </svg>
  ),
  user: () => (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <circle cx="32" cy="24" r="14" fill="#b3b3b3" />
      <rect x="12" y="42" width="40" height="14" rx="7" fill="#b3b3b3" />
    </svg>
  ),
  notion: () => (
    <svg
